...
export const initState = (visibleCondition: ConditionFunc, loadingCondition: ConditionFunc) => (props: object): InitialModalState => ({
...
type WithModalStateV2HOC = (Component: React.Component | React.FunctionComponent) => (props: EnhanceModalStateProps) => any;

export default (propsName: string = defaultPropName, conditions: Conditions): WithModalStateV2HOC => {
